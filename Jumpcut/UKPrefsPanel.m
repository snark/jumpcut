...
-(void)	awakeFromNib
{
	...
	index = (int)[[NSUserDefaults standardUserDefaults] integerForKey:key];
...
-(void) mapTabsToToolbar
{
	...
	itemCount = (int)[tabView numberOfTabViewItems];
...
{
	int					itemCount = (int)[tabView numberOfTabViewItems],
						x;

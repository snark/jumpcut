...
@property (nonatomic, strong) NSArray *transientTypes;
...
-(void)pollPasteboard:(NSTimer *)timer
{
    ...
    if ( self.pbCount != [self.jcPasteboard changeCount] ) {
        ...
        if ( type != nil ) {
            ...
            if (contents != nil && ![self.transientTypes containsObject:frontmostApplication.bundleIdentifier] && ![self.jcPasteboard stringForType:@"PasswordPboardType"]) {
